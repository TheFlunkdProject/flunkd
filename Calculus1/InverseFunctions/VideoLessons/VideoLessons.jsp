<div id="VideoTopicNameHeader" onmouseover="topicsMenuOn()" onmouseout="topicsMenuOff()">
	<h4>1.6 - Inverse Functions - Video Lessons</h4>
</div>
<div id="VideoTotalLength"><h1>Total length of Videos: 5:07</h1>
</div>
...
<div id="VideoLesson1Description">
	<p>larryschmidt<p/>
	<p>Figuring out if a function is one-to-one (really good video)</p>
	<p>Watch 0:00-2:01</p>
	<p>Length 2:01</p>
</div>
...
<div id="VideoLesson2Description">
	<p>patrickJMT</p>
	<p>Finding the inverse of a function: </p>
	<p>Watch 0:00 - 3:06</p>
	<p>Length 3:06</p>
</div>
<iframe width="30%" height="38%" 
